...
export const metadata: Metadata = {
  title: 'Cookies — Fountem',
  description: 'The cookies and local storage Fountem uses, and why.',
}
    ...
    <Container size="narrow">
      <article className="py-14">
        ...
        <p className="mt-2 text-sm text-ink-muted">
          Last updated: June 2026. This explains the cookies and similar technologies Fountem uses. See also our{' '}
        ...
        <div className="mt-10 space-y-10 leading-relaxed text-ink-secondary">
          ...
          <Section title="Managing cookies">
            ...
            you from signing in. Questions: <span className="text-ink">privacy@fountem.ai</span>.
          </Section>
        </div>
      </article>
    </Container>
