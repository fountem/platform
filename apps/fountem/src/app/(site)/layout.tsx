        ...
        <Container>
          <div className="flex h-16 items-center justify-between">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <span className="hidden text-[11px] uppercase tracking-[0.18em] text-ink-muted sm:block">Political intelligence</span>
            </Link>

            <nav className="flex items-center gap-6">
              <Link href="/check" className="hidden text-sm text-ink-secondary transition-colors hover:text-forest-800 sm:block">Check a claim</Link>
              <Link href="/parties" className="hidden text-sm text-ink-secondary transition-colors hover:text-forest-800 sm:block">Parties</Link>
              <Link href="/methodology" className="hidden text-sm text-ink-secondary transition-colors hover:text-forest-800 sm:block">Methodology</Link>
              {user ? (
          ...
          <div className="flex flex-col gap-8 py-12 sm:flex-row sm:items-start sm:justify-between">
            <div className="max-w-sm">
              <div className="flex items-center gap-2 text-parchment">
                ...
                <span className="font-serif text-lg">Fountem</span>
              </div>
              <p className="mt-3 text-sm leading-relaxed text-forest-100/80">
                Evidence-backed UK political intelligence. Every verdict cites its primary source. Proudly non-partisan.
              </p>
            </div>
